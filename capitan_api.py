"""
CAPITAN AI — Enterprise Backend v31.2 (Productivity Edition)
CLOSEAI Technologies — CEO Osinachi Chukwu
World‑Class General‑Purpose Intelligence | Trustworthy | Self‑Learning | Safe
All features intact – base64 icons, correct manifest, research hub, portfolio tabs, no missing components.
"""
...
# ================================================================================
# FOUNDER ONLY DEPENDENCY (moved up to avoid NameError)
# ================================================================================
...
## COMMUNICATION STYLE
- Warm. Precise. Human Natural. Confident. Conversational. Very Calm.
...
@app.get("/")
async def root():
    return {"name": "CAPITAN AI", "version": "31.2", "edition": "Productivity"}

if __name__ == "__main__":
    port = int(os.environ.get("PORT", 8000))
    print(f"\n{'='*70}")
    print(f"🚀 CAPITAN AI v31.2 — Productivity Edition")
